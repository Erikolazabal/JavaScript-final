...
finalizarCompra.addEventListener("click", () => {
    Swal.fire({
        title: "¿Esta seguro que quieres realizar la compra ?",
        icon: "question",
        background: "#FFFFFF",
        backdrop: "rgb(15 15 15 / 73%)",
        confirmButtonText: "Aceptar",
        showCancelButton: true,
        cancelButtonText: "Cancelar",
        cancelButtonColor: "rgb(174 80 80)",
        confirmButtonColor: "rgb(101 153 244)",
    }).then((result) => {
        if (result.isConfirmed) {
            carrito.splice(0, carrito.length);
            actualizarCarrito();
            Swal.fire({
                ...
                backdrop: "rgb(15 15 15 / 73%)",
                confirmButtonText: "Aceptar",
                confirmButtonColor: "rgb(83 159 119)",
            });
        }
    });
